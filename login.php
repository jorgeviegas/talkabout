...
<html lang="en">
    ...
    <body background="css/bglogin.jpg">
        <!--login modal-->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form col-md-12 center-block" action="controller/login.php" method="post">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg btn-block" onclick="document.forms['registro'].submit();">Entrar</button>
